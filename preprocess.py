...
def preprocess(task):
    ...
    for dataset_name in tqdm(dataset_names):
        ...
        for level_name in level_names:
            path = os.path.join('/hdd2/zhangchenbin/data', task, dataset_name, level_name)
                ...
                with open(filename, 'r', encoding='utf-8') as fpr:
                    ...
                    for i in range(len(data_raw['answers'])):
                        ...
                        if len(data_all) % 1000==0:
                            print(len(data_all))
        with open(os.path.join('/hdd2/zhangchenbin/data/race','sequence', dataset_name)+'.json', 'w', encoding='utf-8') as fpw:
